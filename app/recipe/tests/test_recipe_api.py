...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_create_ingredient_on_update(self):
        """ Test creating an ingredient when updating ."""
        recipe = create_recipe(user=self.user)
    ...
    def test_filter_by_tags(self):
        ...
        r2 = create_recipe(user=self.user, title='Thaini')
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title='Posh Toast')
        r2 = create_recipe(user=self.user, title='Chicken Butter')
        ...
        r3 = create_recipe(user=self.user, title='Aloo Pratha')
...
class ImageUploadTests(TestCase):
    ...
    # after every test this method is trigger
    def tearDown(self):
